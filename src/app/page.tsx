...
//               <span className="text-gray-500">{t("home:about.imageAlt")}</span>
//             </div>
//           </div>
//         </div>
//       </section>
...
//                     alt={t(`home:projects.project${project}.title`)}
//                     className="w-full h-full object-cover"
//                   />
//                 </div>
//                 <h3 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-200">
//                   {t(`home:projects.project${project}.title`)}
//                 </h3>
//                 <p className="text-gray-600 group-hover:text-blue-500 transition-colors duration-200">
//                   {t(`home:projects.project${project}.category`)}
//                 </p>
//               </div>
//             ))}
//           </div>
...
//                   className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
//                 >
//                   {isSubmitting ? (
...
//             <div>
//               <h3 className="text-xl font-bold mb-4">UPlus Studio</h3>
//               <p className="text-gray-400">{t("home:footer.description")}</p>
//             </div>
//             <div>
//               <h4 className="font-semibold mb-4">{t("home:footer.services")}</h4>
//               <ul className="space-y-2 text-gray-400">
//                 <li>{t("home:footer.architecture")}</li>
//                 <li>{t("home:footer.interior")}</li>
//                 <li>{t("home:footer.consulting")}</li>
//               </ul>
//             </div>
//             <div>
...
//                 <li>info@uplusstudio.com</li>
//                 <li>İstanbul, Türkiye</li>
//               </ul>
//             </div>
//             <div>
//               <h4 className="font-semibold mb-4">{t("home:footer.follow")}</h4>
...
//             <p>&copy; 2024 UPlus Studio. {t("home:footer.allRights")}</p>
//           </div>
//         </div>
//       </footer>
