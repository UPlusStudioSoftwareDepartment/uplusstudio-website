  ...
  return (
    <>
      ...
      >
        {/* Instagram Icon */}
        <a
          href="https://www.instagram.com/uplu.sstudio/"
          target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                <p className="text-gray-400 italic text-sm mt-1">Mimarlık & Tasarım</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-xs text-gray-300">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="text-gray-400">@uplu.sstudio</span>
                  </div>
                </div>
              </div>
