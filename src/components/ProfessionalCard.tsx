  ...
  return (
    <>
      ...
      >
        {/* Instagram Icon */}
        <a
          href={typeof window !== 'undefined' && /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) 
            ? "instagram://user?username=u.plusstudio" 
            : "https://www.instagram.com/u.plusstudio/"}
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-300 hover:text-white transition-colors"
          onClick={(e) => {
            // Fallback to web if Instagram app is not installed (mobile only)
