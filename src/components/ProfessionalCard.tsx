...
const handleLocation = () => {
  ...
  return (
   ...
   <button
          onClick={() => {
            window.open("https://www.google.com/search?q=U%2B+Studio&sca_esv=c04783e6906b025b&hl=en&authuser=0&sxsrf=ANbL-n5yR-sCljnYlmBhn2-hGqhLC4JNmA%3A1770075633390&ei=8TWBaezFF_XwwPAPzMy5uAg&biw=2048&bih=1054&aic=0&ved=0ahUKEwisgurK_buSAxV1OBAIHUxmDocQ4dUDCBA&uact=5&oq=U%2B+Studio&gs_lp=Egxnd3Mtd2l6LXNlcnAiCVUrIFN0dWRpbzIEECMYJzIEECMYJzIGEAAYFhgeMgYQABgWGB4yBhAAGBYYHjIGEAAYFhgeMgYQABgWGB4yBhAAGBYYHjIGEAAYFhgeSO8HUJAGWJAGcAF4AJABAJgBtAGgAbQBqgEDMC4xuAEDyAEA-AEBmAICoAK_AcICCBAAGLADGO8FwgILEAAYgAQYsAMYogSYAwCIBgGQBgWSBwMxLjGgB6wLsgcDMC4xuAe7AcIHAzItMsgHCIAIAA&sclient=gws-wiz-serp", '_blank', 'noopener,noreferrer');
          }}
          className="text-gray-300 hover:text-white transition-colors bg-transparent border-none cursor-pointer"
        >
          <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
