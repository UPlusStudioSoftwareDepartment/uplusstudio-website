...
export default function MaintenancePage() {
  ...
  initial={{ y: -20 }}
  animate={{ 
    y: [0, -30, 0], // Başlangıç, tepe noktası, bitiş
    transition: {
      y: {
        duration: 2,
        repeat: Infinity,
        ...
        >
          ...
          <div className="flex justify-center space-x-6">
            {[
              { 
                name: 'instagram', 
                url: 'https://www.instagram.com/uplu.sstudio/'
              },
              // { 
              //   name: 'twitter', 
              //   url: 'https://twitter.com/uplusstudio' 
              // },
              // { 
              //   name: 'facebook', 
              //   url: 'https://www.facebook.com/uplusstudio' 
              // },
              // { 
              //   name: 'linkedin', 
              //   url: 'https://www.linkedin.com/company/uplusstudio' 
              // }
            ].map((social) => (
              <a
                key={social.name}
